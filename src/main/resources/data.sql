...
VALUES (1, 1, 'AB 롤아웃 휠', 15000, 0, '찬우짐', 100,
        '/images/items/ab-roller-wheel.webp',
        'AB 롤아웃 휠은 핵심 근육과 상체를 강화하는 데 최적화된 피트니스 도구입니다.\n'
            || '이 휠은 사용자의 체력을 향상시키고, 균형감과 안정성을 높이는 데 도움을 줍니다.\n'
            || '간단하지만 효과적인 운동을 통해 빠르게 원하는 몸매를 만들 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (2, 1, '1kg 덤벨, 2개', 9000, 0, '찬우짐', 100,
        '/images/items/dumbbell-1kg.webp',
        '초보자 및 재활 운동에 최적화된 1kg 덤벨입니다.\n'
            || '덤벨은 다양한 운동 루틴에 활용할 수 있는 다목적 헬스용품입니다.\n'
            || '편안한 그립감으로 운동 시 안정적으로 사용할 수 있으며, 근력 강화와 체력 증진에 효과적입니다.\n'
            || '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, 1, '3kg 덤벨, 2개', 15000, 0, '찬우짐', 100,
        '/images/items/dumbbell-3kg.webp',
        '일상적인 피트니스 루틴에 적합한 중량으로, 근력 향상에 효과적인 3kg 덤벨입니다.\n'
            || '덤벨은 다양한 운동 루틴에 활용할 수 있는 다목적 헬스용품입니다.\n'
            || '편안한 그립감으로 운동 시 안정적으로 사용할 수 있으며, 근력 강화와 체력 증진에 효과적입니다.\n'
            || '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (4, 1, '5kg 덤벨, 2개', 18000, 0, '찬우짐', 100,
        '/images/items/dumbbell-5kg.webp',
        '전신 근력 운동을 위한 표준 중량 덤벨로, 균형 잡힌 근육 발달을 도와주는 5kg 덤벨입니다.\n'
            || '덤벨은 다양한 운동 루틴에 활용할 수 있는 다목적 헬스용품입니다.\n'
            || '편안한 그립감으로 운동 시 안정적으로 사용할 수 있으며, 근력 강화와 체력 증진에 효과적입니다.\n'
            || '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (5, 1, '7kg 덤벨, 2개', 21000, 0, '찬우짐', 100,
        '/images/items/dumbbell-7kg.webp',
        '중급자용 덤벨로 근력 강화와 체력 증진에 탁월한 7kg 덤벨입니다.\n'
            || '덤벨은 다양한 운동 루틴에 활용할 수 있는 다목적 헬스용품입니다.\n'
            || '편안한 그립감으로 운동 시 안정적으로 사용할 수 있으며, 근력 강화와 체력 증진에 효과적입니다.\n'
            || '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (6, 1, '10kg 덤벨, 2개', 24000, 0, '찬우짐', 100,
        '/images/items/dumbbell-10kg.webp',
        '고강도 운동을 위한 무거운 덤벨로 근육 성장과 힘을 극대화하는 10kg 덤벨입니다.\n'
            || '덤벨은 다양한 운동 루틴에 활용할 수 있는 다목적 헬스용품입니다.\n'
            || '편안한 그립감으로 운동 시 안정적으로 사용할 수 있으며, 근력 강화와 체력 증진에 효과적입니다.\n'
            || '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (7, 3, '폼 롤러', 9000, 0, '찬우짐', 100,
        '/images/items/foam-roller.webp',
        '폼 롤러는 근육의 긴장을 풀고 회복을 돕는 필수적인 피트니스 도구입니다.\n'
            || '셀프 마사지와 근막 이완에 탁월하며, 운동 전후의 스트레칭과 유연성 향상에 큰 도움을 줍니다.\n'
            || '초보자부터 전문가까지 모두 사용할 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (8, 3, '헬스 장갑', 13000, 0, '찬우짐', 100,
        '/images/items/gloves.webp',
        '헬스 장갑은 운동 중 손을 보호하고 그립감을 향상시키기 위한 필수 액세서리입니다. 다양한 운동 기구를 사용할 때 손의 피로와 부상을 줄여주며, 땀을 흡수하여 미끄러짐을 방지합니다. 내구성이 뛰어나고 편안한 착용감을 제공하는 헬스 장갑은 운동 효율을 극대화해줍니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (9, 1, '악력기', 9000, 0, '찬우짐', 100,
        '/images/items/gripper.webp',
        '악력기는 손의 근력과 지구력을 강화하는 데 도움을 주는 작은 피트니스 도구입니다.\n'
            || '손과 손목, 전완근을 효과적으로 단련할 수 있으며, 일상생활에서의 그립력을 향상시키고, 다양한 스포츠 및 운동 수행 능력을 높이는 데 유용합니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (10, 2, '실내 사이클 머신', 150000, 0, '찬우짐', 100,
        '/images/items/indoor-cycling-device.webp',
        '실내 사이클 머신은 집에서 편리하게 유산소 운동을 할 수 있는 최적의 기구입니다.\n'
            || '정교한 설계와 다양한 기능으로 사용자의 피트니스 목표를 달성할 수 있도록 돕습니다. 강도 조절이 가능하여 초보자부터 고급 사용자까지 모두 사용할 수 있으며, 심혈관 건강 증진과 체중 감량에 효과적입니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (11, 3, '무릎 보호대, 2개', 18000, 0, '찬우짐', 100,
        '/images/items/knee-guards.webp',
        '무릎 보호대는 무릎 관절을 안정화하고 부상을 예방하는 데 도움을 주는 필수적인 피트니스 도구입니다.\n'
            || '운동 중 또는 일상생활에서 무릎의 부담을 줄이고, 통증을 완화하여 안전하고 효과적인 활동을 지원합니다.\n'
            || '인체공학적 디자인과 고품질 소재로 제작된 무릎 보호대는 편안한 착용감을 제공합니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (12, 3, '리프팅 벨트', 32000, 0, '찬우짐', 100,
        '/images/items/lifting-belt.webp',
        '리프팅 벨트는 중량 운동 시 허리와 복부를 안정화하여 부상을 예방하고, 리프팅 능력을 향상시키는 피트니스 도구입니다.\n'
            || '강력한 지지력과 편안한 착용감으로 데드리프트, 스쿼트 등 고강도 운동을 보다 안전하게 수행할 수 있습니다.\n'
            || '내구성이 뛰어나며, 조절 가능한 디자인으로 다양한 체형에 맞춰 사용할 수 있습니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (13, 3, '헬스 매트', 11000, 0, '찬우짐', 100,
        '/images/items/mat.webp',
        '헬스 매트는 다양한 운동을 안전하고 편안하게 수행할 수 있도록 도와주는 필수적인 피트니스 도구입니다.\n'
            || '고품질의 소재로 제작되어 내구성이 뛰어나며, 쿠션감이 좋아 관절을 보호하고 운동 시 충격을 흡수해줍니다.\n'
            || '요가, 필라테스, 스트레칭, 근력 운동 등 여러 종류의 운동에 적합합니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (14, 3, '32mm 풀업 밴드', 15000, 0, '찬우짐', 100,
        '/images/items/pull-up-band-thick.webp',
        '32mm의 두께로 높은 장력을 가지고 있어, 저강도 풀업 운동에 활용할 수 있는 풀업 밴드입니다.\n'
...
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (15, 3, '16mm 풀업 밴드', 8000, 0, '찬우짐', 100,
        '/images/items/pull-up-band-thin.webp',
        '16mm의 두께로 낮은 장력을 가지고 있어, 고강도 풀업 운동에 활용할 수 있는 풀업 밴드입니다.\n'
            || '풀업 밴드는 다양한 운동 루틴에 활용할 수 있는 다목적 피트니스 도구로, 특히 풀업과 같은 상체 운동을 보조하는 데 유용합니다.\n'
            || '고무 소재로 제작된 이 밴드는 저항력을 제공하여 근력을 강화하고, 운동의 난이도를 조절할 수 있게 해줍니다.');
INSERT INTO item (item_id, category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (16, 1, '스탠드형 풀업 바', 62000, 0, '찬우짐', 100,
        '/images/items/pull-up-bar-stand.webp',
        '스탠드형 풀업 바는 집에서 편리하게 상체 운동을 할 수 있도록 설계된 다목적 피트니스 도구입니다.\n'
