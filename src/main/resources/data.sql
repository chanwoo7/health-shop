...
INSERT INTO member (is_active, reg_date, login_id, name, password)
VALUES (TRUE, '2024-01-01 00:00:00.000000', 'admin', '관리자', '$2a$10$2HytlCWentHkzOtTeb2z5.GUbAsmuBdhlJ/aPOQNtYhfCOOGDzR7O');
...
-- 초기 상품
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, 'AB 롤아웃 휠', 15000, 10, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '1kg 덤벨, 2개', 9000, 7, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '3kg 덤벨, 2개', 15000, 3, '찬우짐', 100,
        ...
        CONCAT('일상적인 피트니스 루틴에 적합한 중량으로, 근력 향상에 효과적인 3kg 덤벨입니다.\n',
            ...
            '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.'));
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '5kg 덤벨, 2개', 18000, 3, '찬우짐', 100,
        ...
        CONCAT('전신 근력 운동을 위한 표준 중량 덤벨로, 균형 잡힌 근육 발달을 도와주는 5kg 덤벨입니다.\n',
            ...
            '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.'));
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '7kg 덤벨, 2개', 21000, 5, '찬우짐', 100,
        ...
        CONCAT('중급자용 덤벨로 근력 강화와 체력 증진에 탁월한 7kg 덤벨입니다.\n',
            ...
            '덤벨을 통해 집에서도 간편하게 전신 운동을 할 수 있습니다.'));
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '10kg 덤벨, 2개', 24000, 5, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '헬스 장갑', 13000, 12, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (2, '실내 사이클 머신', 170000, 15, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '무릎 보호대, 2개', 18000, 7, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '리프팅 벨트', 32000, 2, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '헬스 매트', 11000, 10, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '32mm 풀업 밴드', 15000, 5, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '벽걸이형 풀업 바', 34000, 15, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '푸시업 바, 2개', 16000, 10, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '쉐이커, 700mL', 5000, 3, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (4, '트레이닝 티셔츠', 15000, 20, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '손목 보호대', 13000, 6, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (3, '리프팅 스트랩', 15000, 11, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '플랫 벤치', 75000, 19, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (1, '인클라인 벤치', 84000, 21, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (2, '5kg 케틀벨', 12000, 7, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (2, '트레드밀', 360000, 27, '찬우짐', 100,
...
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (4, '트레이닝 양말', 8000, 3, '찬우짐', 100,
        '/images/items/training-socks.webp',
        CONCAT('트레이닝 양말은 다양한 운동과 활동 중 발을 편안하고 쾌적하게 유지해주는 기능성 의류입니다.\n',
            '통기성이 뛰어나고 땀을 빠르게 흡수하는 소재로 제작되어 발을 시원하고 건조하게 유지하며, 쿠션감과 지지력이 뛰어나 운동 중 발에 가해지는 부담을 줄여줍니다.\n',
            '트레이닝 양말은 모든 운동 애호가들에게 필수적인 아이템입니다.'));
INSERT INTO item (category_id, name, price, discount_rate, brand, stock_quantity, img_path, description)
VALUES (4, '러닝화', 42000, 14, '찬우짐', 100,
        '/images/items/running-shoes.webp',
        CONCAT('러닝화는 달리기와 걷기 등 유산소 운동 시 발을 보호하고, 최적의 퍼포먼스를 발휘할 수 있도록 설계된 기능성 운동화입니다.\n',
            '경량 소재와 뛰어난 쿠셔닝, 안정적인 지지력을 제공하여 장거리 러닝에서도 발의 피로를 최소화합니다.\n',
            '또한 발의 자연스러운 움직임을 지원하는 인체공학적 디자인으로 편안한 착용감을 제공합니다.'));
